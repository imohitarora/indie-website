...
const ourTeam = {
  coreTeam: [
    {
      ...
      title: "Founder, CEO",
      description:
        "Award-winning entrepreneur dedicated to transforming the consultant marketplace.",
    ...
    },
    {
      ...
      title: "CTO",
      description:
        "Experienced Software Architect passionate about innovative solutions and leadership.",
    ...
    },
    {
      ...
      title: "Head Quant",
      description:
        "Quantitative expert with a passion for risk management and technology.",
  ...
  advisoryTeam: [
    ...
    },
    {
      ...
      description:
        "Veteran in the finance industry with a focus on data analytics and risk management.",
    ...
    },
    {
      ...
      description:
        "Expert in quantitative techniques and risk management practices in banking.",
...
function TeamMember({
  ...
  return (
    <a
      className="flex flex-col border-l-2 pl-4 border-gray-200 hover:border-primary-main md:flex-row items-center justify-center md:justify-between mb-8"
      target="_blank"
      rel="noreferrer"
      href={link}
    >
    ...
    <SectionWrapper>
      <div className="p-8 grid lg:grid-cols-2 gap-10">
        <div className="">
          ...
          <p className="">
            <strong>Our Mission:</strong> Empower enterprises to manage
            consultants effortlessly, provide consulting firms with avenues for
            growth and collaboration, and elevate the careers of independent
            consultants through unparalleled opportunities.
          </p>
