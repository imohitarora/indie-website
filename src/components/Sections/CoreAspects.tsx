            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="order-1 my-auto">
                <div className="text-left">
                  ...
                  <p className="mt-4 text-lg ">
                    We&apos;ve revolutionized how consultants and clients
                    connect. Consultants play an active role in contract
                    negotiations, ensuring alignment from the start. Meanwhile,
                    hiring managers can easily post engagements, attracting top
                    talent with minimal effort.
                  </p>
                </div>
              </div>
              <div>
